                ...
                <div className="flex-grow h-full p-6 overflow-auto bg-gray-50 ">
                  {!isSubmitSuccessful && (
                    <form onSubmit={handleSubmit(onSubmit)} noValidate>
                      <input
                        type="hidden"
                        value="5602856e-c656-44ce-8d3d-ab3533931326"
                        {...register("apikey")}
                      />
                      <input
                        type="hidden"
                        value={`${userName} ha enviado un mensaje desde el formulario de contacto de la página web`}
                        {...register("subject")}
                      />
                      <input
                        type="hidden"
                        value="Soluciones Digitales"
                        {...register("from_name")}
                      />
                      <input
                        type="checkbox"
                      ...
                      <div className="mb-4">
                        ...
                        <textarea
                          ...
                          id="message"
                          {...register("message", {
                            required: "Escribenos un mensaje",
                          })}
                    ...
                    <>
                      <div className="flex flex-col items-center justify-center h-full text-center text-white rounded-md">
                        ...
                        <h3 className="py-5 text-xl text-green-500">
                          Te contactaremos pronto! Gracias por tu mensaje!
                        </h3>
